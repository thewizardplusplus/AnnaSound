...
public:
	...
	virtual SourceState::Types getState(void) const = 0;
	virtual float getOffset(SourceOffsetUnits::Types units) const = 0;
	virtual void setOffset(float offset, SourceOffsetUnits::Types units) = 0;
